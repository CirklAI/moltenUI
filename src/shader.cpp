...
static void createPipelineStages(VkShaderModule shaderMod, VkPipelineShaderStageCreateInfo *stages) {
...
Shader::Shader(const std::string &shaderPath) {
	...
	VkShaderModule shaderMod = createShaderModule(code);

	VkPipelineShaderStageCreateInfo stages[2];
	createPipelineStages(shaderMod, stages);
...
Shader::Shader(const std::vector<uint32_t> &spirvData) {
	VkShaderModule shaderMod = createShaderModule(spirvData);
